...
class _ArticleDetailsScreenState extends State<ArticleDetailsScreen> {
  ...
  void initState() {
    ...
    pr(id, '$t articleId');
    _getArticleController.getArticle(id: id!).then((value) {
      articleModel = value;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<GetArticleController>(builder: (_) {
      return Scaffold(
            ...
            ? Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GetBuilder<ArticlesDetailsController>(builder: (_) {
                      return Visibility(
                        visible: pr(ArticleDetailsData.relatedArticles, 'test data in view').isNotEmpty,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Padding(
